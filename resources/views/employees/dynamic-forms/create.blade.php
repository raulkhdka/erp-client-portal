...
class DynamicFormBuilder {
    constructor() {
        ...
        this.isDraft = true; // Default to draft for new forms
    ...
    bindEvents() {
        ...
        document.getElementById('is_active')?.addEventListener('change', (e) => {
            ...
            if (e.target.checked) {
                ...
                this.isDraft = false; // Active means not a draft
            } else {
                badge.textContent = 'Inactive';
                badge.className = 'badge bg-secondary';
                this.isDraft = true; // Inactive means draft
    ...
    async handleSubmit(e) {
        ...
        this.hideErrors();
        // Show loading overlay (assuming partials/modals.blade.php provides it)
