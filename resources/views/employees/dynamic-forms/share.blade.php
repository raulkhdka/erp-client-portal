...
@unless (Auth::id() == $form->employee_id)
    <div class="alert alert-danger alert-modern" role="alert">
        You do not have permission to share this form.
        <a href="{{ route('employees.dynamic-forms.index') }}" class="alert-link">Return to My Forms</a>.
    </div>
@elseif ($form->is_draft)
    <div class="alert alert-warning alert-modern" role="alert">
        This form is a draft and cannot be shared until published.
        <a href="{{ route('employees.dynamic-forms.edit', $form->id) }}" class="alert-link">Edit Form to Publish</a>.
    </div>
@else
    <!-- Loading Overlay -->
    ...
    <div class="share-container">
        ...
        <form id="shareForm" method="POST" action="{{ route('employees.dynamic-forms.send', $form->id) }}" novalidate>
            @csrf
