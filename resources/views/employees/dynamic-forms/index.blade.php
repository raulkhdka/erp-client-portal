...
@section('title', 'My Dynamic Forms')

@section('breadcrumb')
    <span class="breadcrumb-item active">My Dynamic Forms</span>
@endsection

@section('actions')
    <div class="btn-group">
        <a href="{{ route('employees.dynamic-forms.create') }}" class="btn btn-primary">
...
<div class="container-fluid">
    ...
    <div class="main-card">
        <div class="card-header-custom">
            <div class="row align-items-center">
                <div class="col">
                    <h5 class="mb-0"><i class="fas fa-list me-2"></i>My Forms Management</h5>
                </div>
                <div class="col-auto">
                            ...
                            <tr data-form-name="{{ strtolower($form->name) }}"
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('employees.dynamic-forms.show', $form->id) }}"
                                           class="btn btn-info btn-action"
                                           title="View Form"
                                           data-bs-toggle="tooltip">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('employees.dynamic-forms.edit', $form->id) }}"
                                        ...
                                        <a href="{{ route('employees.dynamic-forms.share', $form->id) }}"
                                           class="btn btn-share btn-action"
                                           title="Share Form"
                                           data-bs-toggle="tooltip">
                                            <i class="fas fa-share-alt"></i>
                                        </a>
                                        <form action="{{ route('employees.dynamic-forms.destroy', $form->id) }}"
                                              method="POST"
