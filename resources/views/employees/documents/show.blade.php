        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                <div class="btn-group-vertical" role="group">
                    <a href="{{ route('employee.documents.download', $document) }}" class="btn btn-light btn-lg mb-2">
                        <i class="fas fa-download me-2"></i>Download
                    </a>
                    @if(in_array(strtolower($document->file_type), ['pdf', 'jpg', 'jpeg', 'png', 'gif', 'svg', 'txt']))
                        <a href="{{ route('employee.documents.preview', $document) }}" class="btn btn-outline-light mb-2" target="_blank">
                    ...
                    <div class="card-body p-0">
                        <div class="preview-container">
                            @if(strtolower($document->file_type) === 'pdf')
                                <iframe src="{{ route('employee.documents.preview', $document) }}" width="100%" height="600px"></iframe>
                            @elseif(in_array(strtolower($document->file_type), ['jpg', 'jpeg', 'png', 'gif', 'svg']))
                                <img src="{{ route('employee.documents.preview', $document) }}" class="img-fluid">
