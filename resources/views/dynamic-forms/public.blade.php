    ...
    <div class="form-container">
        ...
        @if ($form->exists)
            @if ($hasSubmitted)
                ...
                @endif
            @else
                <form id="publicForm" method="POST" action="{{ route('dynamic-forms.submit', ['form' => $form->id]) }}" novalidate enctype="multipart/form-data" role="form" aria-labelledby="formTitle">
                    @csrf
