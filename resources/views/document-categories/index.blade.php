                        ...
                        <tbody>
                            @forelse ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('document-categories.show', $category->id) }}"
                                    ...
                                    <td class="text-end">
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm edit-category-btn"
                                            ...
                                            data-update-url="{{ route('document-categories.update', $category->id) }}"
                                            title="Edit">
    ...
    <div class="modal fade" id="createCategoryModal" tabindex="-1" aria-labelledby="createCategoryModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('document-categories.store') }}" method="POST" id="createCategoryForm">
                    @csrf
