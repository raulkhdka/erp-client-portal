...
@section('actions')
    <div class="btn-group">
        <a href="{{ route('admin.dynamic-forms.show', $form) }}" class="btn btn-info">
...
<div class="row">
    ...
    <div class="col-lg-6" id="builderColumn">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                <form id="dynamicFormEdit" novalidate method="POST" action="{{ route('admin.dynamic-forms.update', $form->id) }}">
                    @csrf
                    @method('PATCH')
...
class DynamicFormBuilder {
    ...
    async handleSubmit(e) {
        ...
        try {
            ...
            const response = await axios.post('{{ route("admin.dynamic-forms.update", $form->id) }}', formData, {
                headers: {
