...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <a href="{{ route('admin.dynamic-forms.index') }}" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-2"></i>Back to Forms
        </a>
    </div>
</div>
...
class DynamicFormBuilder {
    ...
    addField(type = 'text', fieldData = null) {
        ...
        // Auto-show preview if first field
    ...
    handleFieldTypeChange(selectElement) {
        ...
        if (optionsContainer) {
            ...
            // Make options required if needed
    ...
    updateStatistics() {
        ...
        const estimatedTime = Math.ceil(total * 0.5); // Estimate 30 seconds per field
    ...
    updatePreview() {
        ...
        // Update fullscreen preview titles
    ...
    async handleSubmit(e) {
        ...
        try {
            ...
            const response = await axios.post('{{ route("admin.dynamic-forms.store") }}', formData, {
                headers: {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => {
                    window.location.href = response.data.redirect || '{{ route("admin.dynamic-forms.index") }}';
                }, 2000);
            } else {
                this.showErrors(response.data.errors || { general: 'An error occurred while saving the form' });
            }
