...
@section('actions')
    <div class="btn-group">
        <a href="{{ route('admin.call-logs.show', $callLog) }}" class="btn btn-info">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.call-logs.index') }}" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.call-logs.update', $callLog) }}" method="POST">
                        @csrf
                        @method('PUT')
