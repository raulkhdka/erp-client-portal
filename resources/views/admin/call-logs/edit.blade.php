            ...
            <form action="{{ route('admin.call-logs.update', $callLog->id) }}" method="POST">
                            ...
                            <div class="col-md-4 call-date-container">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                        ...
                                        id="call_date" name="call_date" value="{{ old('call_date', $callLog->call_date_formatted) }}"
                            ...
                            <div class="col-md-4 call-time-container">
                                ...
                                <div class="input-group">
                                    <input type="time"
                                        ...
                                        value="{{ old('call_time', $callLog->call_time ? \Carbon\Carbon::parse($callLog->call_time)->format('H:i') : now()->format('H:i')) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('caller_name', $callLog->caller_name) }}" maxlength="255"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('duration_minutes', $callLog->duration_minutes) }}" min="0"
                            ...
                            <div class="col-md-6 subject-container">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="subject" name="subject" value="{{ old('subject', $callLog->subject) }}"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('follow_up_required') is-invalid @enderror" id="follow_up_required"
                                    name="follow_up_required" rows="2">{{ old('follow_up_required', $callLog->follow_up_required) }}</textarea>
                                @error('follow_up_required')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-3 follow-up-date-container">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                        ...
                                        value="{{ old('follow_up_date', $callLog->follow_up_date_formatted) }}" placeholder="YYYY-MM-DD"
                            ...
                            <div class="col-md-3 follow-up-time-container">
                                <label for="follow_up_time" class="form-label">Next Call
                                ...
                                <div class="input-group">
                                    <input type="time"
                                        ...
                                        value="{{ old('follow_up_time', $callLog->follow_up_time ? \Carbon\Carbon::parse($callLog->follow_up_time)->format('H:i') : now()->format('H:i')) }}" required>
                                    <span class="input-group-text"><i class="fas fa-clock"></i></span>
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-start gap-3">
                        <div style="flex: 0 0 60%;">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="create_task"
                                    ...
                                    {{ old('create_task', $callLog->create_task) ? 'checked' : '' }}>
                        ...
                        <div style="flex: 0 0 40%;" id="assigned_to_container"
                            style="display: {{ old('create_task', $callLog->create_task) ? 'block' : 'none' }};">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select @error('assigned_to') is-invalid @enderror"
                                    ...
                                    @foreach ($employees as $employee)
                                        <option value="{{ $employee->id }}"
                                            {{ old('assigned_to', $callLog->assigned_to) == $employee->id ? 'selected' : '' }}>
                                            {{ $employee->name }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary"><i
                            class="fas fa-save me-2"></i>Update Call</button>
                </div>
            </form>
        </div>
    </div>
