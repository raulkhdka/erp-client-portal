                                    ...
                                    <div class="mb-4">
                                        <div class="d-flex align-items-start gap-3">
                                            <div style="flex: 0 0 60%;">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="create_task"
                                                        name="create_task" value="0"
                                                        {{ old('create_task', true) ? '' : 'disabled' }}>
                                                    <!-- use old('create_task', true) ? 'checked': '' for check box to select -->
                                            ...
                                            <div style="flex: 0 0 40%;" id="assigned_to_container"
                                                ...
                                                <label for="assigned_to" class="form-label assigned-task-label">Assign
                                                    Task To</label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const employeeSelect = new TomSelect('#employee_id', {
            ...
            const assignedToSelect = new TomSelect('#assigned_to', {
                placeholder: 'Select employee...',
                allowEmptyOption: true,
                create: false
            });

            // Track if assigned_to has been manually changed
            let assignedToManuallyChanged = false;
            assignedToSelect.on('change', function() {
                assignedToManuallyChanged = true;
            });

            // Sync assigned_to with employee_id, but only if not manually changed
            ...
            // Toggle assigned_to visibility and initialize value
