...
@section('styles')
    ...
    <style>
        ...
        .form-shell {
            --stack-offset: 160px;
            /* adjust to your header/breadcrumb/actions total height if needed */
        }
...
@section('content')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="username" readonly
                                    placeholder="Will generate from name">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control @error('emails.0.email') is-invalid @enderror"
                                    ...
                                    value="{{ old('emails.0.email') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="emails[0][type]">
                                <option value="primary"
                                    {{ old('emails.0.type', 'primary') == 'primary' ? 'selected' : '' }}>Primary</option>
                                <option value="billing" {{ old('emails.0.type') == 'billing' ? 'selected' : '' }}>Billing
                                </option>
                                <option value="support" {{ old('emails.0.type') == 'support' ? 'selected' : '' }}>Support
                                </option>
                                <option value="personal" {{ old('emails.0.type') == 'personal' ? 'selected' : '' }}>
                                    Personal</option>
                            </select>
                        </div>
                    ...
                    <div class="row phone-item align-items-end g-3 mb-2">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="phones[0][phone]"
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="phones[0][type]">
                                <option value="mobile" {{ old('phones.0.type', 'mobile') == 'mobile' ? 'selected' : '' }}>
                                    Mobile</option>
                                <option value="office" {{ old('phones.0.type') == 'office' ? 'selected' : '' }}>Office
                                </option>
                                <option value="home" {{ old('phones.0.type') == 'home' ? 'selected' : '' }}>Home
                                </option>
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#quickServiceModal">
                ...
                @if ($services->count() === 0)
                    <div class="alert alert-info" id="noServicesAlert">
                        ...
                        No services available. You can <button type="button" class="btn btn-link p-0 align-baseline"
                            data-bs-toggle="modal" data-bs-target="#quickServiceModal">create a service</button> or
                        <a href="{{ route('admin.services.index') }}" class="alert-link" target="_blank">manage all
                            services</a>.
                    </div>
                @endif
                ...
                <div class="subcard">
                    ...
                    <select id="servicesSelect" name="services[]" multiple class="form-select"
                ...
                <div class="subcard">
                            ...
                            <select class="form-select @error('assigned_employee') is-invalid @enderror"
                                ...
                                @foreach ($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                        {{ old('assigned_employee') == $employee->id ? 'selected' : '' }}>
                                        {{ $employee->name }}
                    ...
                    @else
                        <div class="alert alert-info m-0">
                            <i class="fas fa-info-circle me-2"></i>
                            No active employees available for assignment. <a
                                href="{{ route('admin.employees.create') }}">Create an employee</a> first.
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="modal fade" id="quickServiceModal" tabindex="-1" aria-labelledby="quickServiceModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form id="quickServiceForm">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="mb-3">
                                    <label for="quickServiceName" class="form-label">Service Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="quickServiceName" name="name"
                                        required maxlength="255">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="quickServiceType" class="form-label">Type <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="quickServiceActive" name="is_active"
                                value="1" checked>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            [].slice.call(tooltipTriggerList).map(function(el) {
                ...
                var ts = new TomSelect(servicesSelectEl, {
                    ...
                    render: {
                        option: function(data, escape) {
                            var detail = data.detail || (data.$option && data.$option.dataset ? data
            ...
            document.getElementById('addPhone').addEventListener('click', function() {
                ...
                var phoneHTML =
                    ...
                    '          <div class="input-group">' +
                    '            <span class="input-group-text"><i class="fas fa-hashtag"></i></span>' +
                    '            <input type="text" class="form-control" name="phones[' + phoneIndex +
            ...
            document.getElementById('addEmail').addEventListener('click', function() {
                ...
                var emailHTML =
                    ...
                    '          <div class="input-group">' +
                    '            <span class="input-group-text"><i class="fas fa-at"></i></span>' +
                    '            <input type="email" class="form-control" name="emails[' + emailIndex +
                ...
                .then(function(data) {
                    if (data.success) {
                        ...
                        if (data.errors) {
                            ...
                            errorDiv.innerHTML =
                                '<div class="text-danger small">An error occurred while creating the service.</div>';
                        }
                    }
                })
                .catch(function(error) {
                    console.error('Error:', error);
                    document.getElementById('quickServiceErrors').innerHTML =
                        '<div class="text-danger small">Network error occurred.</div>';
                });
        }
    </script>
@endpush
