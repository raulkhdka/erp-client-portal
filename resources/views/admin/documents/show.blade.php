            ...
            <div class="col-md-4 text-end">
                <div class="btn-group-vertical" role="group">
                    ...
                    @if(in_array(strtolower($document->file_type), ['pdf', 'jpg', 'jpeg', 'png', 'gif', 'svg', 'txt']))
                        <a href="{{ route('admin.documents.preview', $document) }}" class="btn btn-outline-light mb-2" target="_blank">
                            <i class="fas fa-eye me-2"></i>Preview
                        </a>
                    @endif
                    @if($document->uploaded_by === Auth::id() || Auth::user()->isAdmin())
                        <a href="{{ route('admin.documents.edit', $document) }}" class="btn btn-outline-light mb-2">
                            <i class="fas fa-edit me-2"></i>Edit
                        </a>
                        <a href="{{ route('admin.documents.manage-access', $document) }}" class="btn btn-outline-light">
        ...
        <div class="col-md-4">
            ...
            @if($document->uploaded_by === Auth::id() || Auth::user()->isAdmin())
                <div class="card action-card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.documents.destroy', $document) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                            @csrf
                            @method('DELETE')
