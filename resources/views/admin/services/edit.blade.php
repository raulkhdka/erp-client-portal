...
@section('breadcrumb')
    <div class="breadcrumb-nav d-flex align-items-center">
        ...
        <a href="{{ route('admin.services.show', $service) }}" class="text-decoration-none text-dark">{{ $service->name }}</a>
        <span class="mx-2">/</span>
        <span class="text-primary fw-bold">Edit</span>
    </div>
@endsection

@section('actions')
    <div class="d-flex align-items-center gap-3">
        {{-- <a href="{{ route('admin.services.show', $service) }}" class="btn btn-ghost-danger btn-sm rounded-pill shadow-sm btn-back">
                        ...
                        <div class="mb-4">
                            <div class="section-title">
                                ...
                                <div>
                                    ...
                                    <div class="section-subtext">Update the service details and settings.</div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control @error('detail') is-invalid @enderror"
                                                  ...
                                                  style="border-radius: 12px;">{{ old('detail', $service->detail) }}</textarea>
                                        @error('detail')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
