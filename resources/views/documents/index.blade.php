            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="document-card p-3">
                    ...
                    @if($document->category)
                        <span class="badge category-badge mb-2" style="background-color: {{ $document->category->color }}">
                            ...
                            @foreach($documents->take(5) as $doc)
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <a href="{{ route('documents.manage-access', $doc) }}" class="btn btn-sm btn-outline-primary ms-2">
                                            Manage
                                        </a>
                                    </div>
                                </div>
